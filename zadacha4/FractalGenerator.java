...
{
	//Преобразует целочисленные координаты в значение double
	...
	//Обновление текущего диапазона для указанного центра
	...
	//Задает указанный прямоугольник
	public abstract void getInitialRange(Rectangle2D.Double range);
	//Вычисляет количество итераций для фрактала,
	//если достигает предела, возвращает -1
